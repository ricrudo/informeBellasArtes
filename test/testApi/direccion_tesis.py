...
url = '/investigacion/direcion_tesis'
data = {
'bool_direccion_tg' : 'si',
...
'programa_1' : 'licenciatura_en_musica',
'status_1' : 'en_proceso',
...
'programa_2' : 'artes_plasticas',
'status_2' : 'esperando_sustentacion',
...
en_poceso no es un valor valido
'''
